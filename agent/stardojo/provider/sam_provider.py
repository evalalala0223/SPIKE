...
from stardojo.utils.image_utils import (
    resize_image,
...
from stardojo.utils.template_matching import icons_match
from stardojo.provider.video.video_ocr_extractor import VideoOCRExtractorProvider
