...
from stardojo.gameio.gui_utils import TargetWindow, _get_active_window, check_window_conditions, is_top_level_window
from stardojo.log import Logger
from stardojo.gameio import IOEnvironment
# from stardojo.utils.image_utils import draw_mouse_pointer_file_, crop_grow_image
from stardojo.utils.os_utils import getProcessIDByWindowHandle, getProcessNameByPID
    ...
    if result == False:
        ...
        if result == False and ("CapCut" in config.env_name or "XiuXiu" in config.env_name):
            ...
            if len(named_windows) > 0:
                ...
                #     from stardojo.environment.capcut.atomic_skills import click_at_position
