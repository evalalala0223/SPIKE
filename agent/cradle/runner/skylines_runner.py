...
from cradle.provider import SkylinesSelfReflectionPreprocessProvider
...
from cradle.provider import SkylinesTaskInferencePreprocessProvider
...
from cradle.provider import SkylinesActionPlanningPreprocessProvider
...
class PipelineRunner():
    ...
    def set_internal_params(self, *args, **kwargs):
        ...
        self.self_reflection_preprocess = SkylinesSelfReflectionPreprocessProvider(
            gm=self.gm,
            use_screenshot_augmented=True,
        )
        ...
        self.task_inference_preprocess = SkylinesTaskInferencePreprocessProvider(
            gm=self.gm,
            use_screenshot_augmented=True,
        )
        ...
        self.action_planning_preprocess = SkylinesActionPlanningPreprocessProvider(
            gm=self.gm,
            use_screenshot_augmented=True,
        )
