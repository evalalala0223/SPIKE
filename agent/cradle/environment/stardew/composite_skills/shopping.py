...
def go_to_store():
    ...
    """
    return go_to_icon("store_door", iterations=DEFAULT_GO_TO_STORE_ITERATIONS, terminal_threshold=DEFAULT_GO_TO_STORE_TERMINAL_THRESHOLD, debug=False, gm=None, character=["up", "down", "left", "right"])
