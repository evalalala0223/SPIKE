...
from cradle.environment.stardew.composite_skills.go_home import go_home
config = Config()
logger = Logger()
...
def go_through_door(door):
    ...
    """
    return go_to_icon(door, iterations=DEFAULT_GO_THROUGH_DOOR_ITERATIONS, terminal_threshold=DEFAULT_GO_THROUGH_DOOR_TERMINAL_THRESHOLD, debug=False, gm=None, character=["up", "down", "left", "right"])
